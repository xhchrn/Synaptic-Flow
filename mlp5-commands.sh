python3 main.py --gpu 1 \
    ...
    --load-init ./mnist/mlp5/initial_classifier_state_dict_lt.pt \
    --pruner synflow --compression 1.0 --mask-scope local \
    --experiment singleshot --expid 0 \
    --result-dir mnist/mlp5_sf --seed 118
...
python3 main.py --gpu 2 \
    ...
    --experiment singleshot --expid 0 \
    --result-dir mnist/mlp5_grasp --seed 118
...
python3 main.py --gpu 3 \
    ...
    --experiment singleshot --expid 0 \
    --result-dir mnist/mlp5_snip --seed 118
...
python3 main.py --gpu 4 \
    ...
    --experiment singleshot --expid 0 \
    --result-dir mnist/mlp5_mag --seed 118
